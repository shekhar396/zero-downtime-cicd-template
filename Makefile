...
help:
	...
	@echo ""
	@echo "State:"
	@echo "  make init-service SERVICE=zero-downtime-demo-go"
	@echo "  make show-state SERVICE=zero-downtime-demo-go"
	@echo ""
	@echo "Release artifacts:"
	@echo "  make create-release SERVICE=zero-downtime-demo-go ARTIFACT=../zero-downtime-demo-go/bin/zero-downtime-demo-go"
	@echo "  make list-releases SERVICE=zero-downtime-demo-go"
	@echo ""
	@echo "Runtime colors:"
	@echo "  make start-color SERVICE=zero-downtime-demo-go COLOR=green RELEASE=<release_id>"
	@echo "  make status-color SERVICE=zero-downtime-demo-go COLOR=green"
	@echo "  make stop-color SERVICE=zero-downtime-demo-go COLOR=green"
	@echo ""
	@echo "Health and proxy:"
	...
	@echo "  make switch-traffic-dry-run SERVICE=zero-downtime-demo-go COLOR=green"
	@echo ""
	@echo "Deploy and rollback:"
	@echo "  make deploy-dry-run SERVICE=zero-downtime-demo-go ARTIFACT=../zero-downtime-demo-go/bin/zero-downtime-demo-go"
	@echo "  make deploy SERVICE=zero-downtime-demo-go ARTIFACT=../zero-downtime-demo-go/bin/zero-downtime-demo-go"
	@echo "  make rollback-dry-run SERVICE=zero-downtime-demo-go"
	@echo "  make rollback SERVICE=zero-downtime-demo-go"
	@echo ""
	@echo "Docs:"
